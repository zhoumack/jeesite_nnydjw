...
public class AccessToken implements ResultCheck, Serializable {
    ...
    public AccessToken(String jsonStr) {
        this.json = jsonStr;
        try {
            Map<String, Object> temp = (Map<String, Object>) JsonMapper.fromJsonString(jsonStr, Map.class);
            ...
            // 用户缓存时还原
            if (temp.containsKey("expiredTime")&&!temp.get("expiredTime").toString().equals("")) {
    ...
    public String getCacheJson() {
        Map<String, Object> temp =  (Map<String, Object>) JsonMapper.fromJsonString(json, Map.class);
