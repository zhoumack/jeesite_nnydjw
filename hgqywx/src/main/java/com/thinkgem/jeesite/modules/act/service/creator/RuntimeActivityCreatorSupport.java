...
public abstract class RuntimeActivityCreatorSupport {
	...
	protected String createUniqueActivityId(String processInstanceId, String prototypeActivityId) {
		String[] args=prototypeActivityId.split(":");
		if(args.length>0){
			return args[0] + ":" + System.currentTimeMillis() + "-" + (SEQUNCE_NUMBER++);
		}
		return   prototypeActivityId + ":" + System.currentTimeMillis() + "-" + (SEQUNCE_NUMBER++);
	}
