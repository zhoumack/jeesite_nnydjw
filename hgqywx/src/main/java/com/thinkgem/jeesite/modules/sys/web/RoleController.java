...
//		}
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "treejson1")
	public List treeJson1(HttpServletRequest request,HttpServletResponse response,String renname) {
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "getRoleByCurrentUser")
	public String  getRoleByCurrentUser(Model model){
		return UserUtils.getRoleByUserId();
	}
}
