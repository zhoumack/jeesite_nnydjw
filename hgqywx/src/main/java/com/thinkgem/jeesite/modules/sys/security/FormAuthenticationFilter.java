...
public class FormAuthenticationFilter extends org.apache.shiro.web.filter.authc.FormAuthenticationFilter {
	...
	public static final String DEFAULT_TYPE_PARAM = "loginType";

	private String captchaParam = DEFAULT_CAPTCHA_PARAM;
	private String mobileLoginParam = DEFAULT_MOBILE_PARAM;
	private String messageParam = DEFAULT_MESSAGE_PARAM;
	private String loginType = DEFAULT_TYPE_PARAM;
	...
	protected String getLoginType(ServletRequest request) {
		String loginType =  StringUtils.toString(request.getAttribute(DEFAULT_TYPE_PARAM), StringUtils.EMPTY);
        return loginType;
    }
