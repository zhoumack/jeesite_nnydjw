...
public class SystemService extends BaseService implements InitializingBean {
	...
	@SuppressWarnings("unchecked")
	public List<String> findUserLoginNameByOfficeId(String officeId) {
		 List<User> users=findUserByOfficeId(officeId);
	...
	/*
	 * 根据approve 得到审批人loginName 集合
	 */
	public  List<String> getAssigns(List<String> officeIds,List<String> userids){
		List<String> loginNames=new ArrayList<String>();
		List<String> users=new ArrayList<String>();
		if(officeIds!=null){
			for(String oid:officeIds){
				users.addAll(findUserLoginNameByOfficeId(oid));
			}
		}
		if(officeIds!=null){
			for(String uid:userids){
				users.add(UserUtils.get(uid).getLoginName());
			}
		}
		return users;
	}
	 ...
	 * 根据copy得到抄送人信息
	 */
	public  List<User> getAssignsForCs(List<String> officeIds,List<String> userids){
		List<User> users=new ArrayList<User>();
		for(String oid:officeIds){
			users.addAll( findUserByOfficeId(oid));
		}
		for(String uid:userids){
			users.add(UserUtils.get(uid));
		}
		return users;
	}
	/**
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public List<User> getByOfficeId(String officeid){
		return userDao.getByOfficeId(officeid);
	};
