...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	...
	public static final String[] PD_QingJia = new String[]{"qingJia", "t_qingjia"};
	public static final String[] PD_Chuchai = new String[]{"chuchai","t_chuchai"};
	public static final String[] PD_JiaBan = new String[]{"jiaban","t_jiaban"};
	public static final String[] PD_YongZhang = new String[]{"yongzhang","t_yongzhang"};
	//public static final String[] PD_WeiXiu = new String[]{"weixiu","t_weixiu"};
	public static final String[] PD_WaiChu = new String[]{"waichu","t_waichu"};
	public static final String[] PD_Bgyplq = new String[]{"bgyplq","t_bgyplq"};
	public static final String[] PD_PaiChe = new String[] {"paiche","t_paiche"};
	public static final String[] PD_HuiYi = new String[] {"huiyi","t_huiyi"};
	...
	public static final String[] PD_JieDai = new String[]{"jiedai","t_jiedai"};
	public static final String[] PD_Bangongqu = new String[] {"bangongqu","t_bangongqu"};
	public static final String[] PD_Yongjing = new String[] {"yongjing","t_yongjing"};
	public static final String[] PD_SBWX = new String[] {"sbwx1","t_weixiu"};

//	public static final String[] PD_BaoXiao = new String[]{"baoxiao","t_baoxiao"};
//	public static final String[] PD_WaiChu = new String[]{"waichu","t_waichu"};
//	
//	public static final String[] PD_Gdzcsq = new String[]{"gdzcsq","t_gdzcsq"};
//	public static final String[] PD_Weixiu = new String[]{"weixiu","t_weixiu"};
	public static final String[] PD_Renwu = new String[]{"renwu","t_renwu"};
//	/**
//	 * 流程定义Map（自动初始化）
//	 */
...
//		}
//		return url;
//	}1.同意，2不同意，3转审，4回退,5加签
	public static String parseToFlag(String type) {
	...
	public static String getComment(String flag,String comment) {
		if(flag.equalsIgnoreCase(parseToFlag(flag))){
			return flag;
		}else{
			if(StringUtils.isNoneBlank(comment))
				return parseToFlag(flag)+":"+comment;
			else
				return  parseToFlag(flag);
		}
	}
