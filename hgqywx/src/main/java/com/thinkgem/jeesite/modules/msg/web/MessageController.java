...
import com.thinkgem.jeesite.modules.msg.service.MessageService;
...
public class MessageController extends BaseController {
	...
	@RequiresPermissions("msg:message:view")
	...
	@RequiresPermissions("msg:message:edit")
	...
	public String save(Message message, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/msg/message/?repage";
	}
