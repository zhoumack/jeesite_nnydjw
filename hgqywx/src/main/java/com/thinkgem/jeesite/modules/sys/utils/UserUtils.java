...
public class UserUtils {
	 ...
	 * @return
	 */
	public static List<Role> getRoleListNoScop(){
		@SuppressWarnings("unchecked")
		List<Role> roleList = (List<Role>)getCache(CACHE_ROLE_LIST);
		if (roleList == null){
			User user = getUser();
	...
	public static List<Role> getRoleListById(String userId){
		@SuppressWarnings("unchecked")
		List<Role> roleList =ListUtils.EMPTY_LIST;
...
//		getCacheMap().remove(key);
	...
	public static String  getRoleByUserId() {
		List<Role> roles=getRoleListNoScop();
		...
		if(sb.toString().contains("fgld")||sb.toString().contains("yld")){
			...
			return "bmld";//部门领导
		}else if(sb.toString().contains("_nq")||sb.toString().contains("_sibz")){
			return "nq";
		}else {
			return "ganjing";//干警
		}
	...
	public static String  getRoleByUserId(String userId) {
		List<Role> roles=getRoleListById(userId);
		StringBuilder sb=new StringBuilder();
		for(Role r:roles){
			sb.append("|"+r.getEnname());
		}
