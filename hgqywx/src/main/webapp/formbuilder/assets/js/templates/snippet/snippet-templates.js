define(function(require) {
  ...
  , textinput                = require('text!templates/snippet/textinput.html')
  , constomtextinput         = require('text!templates/snippet/constomtextinput.html')
  , constomtextarea          = require('text!templates/snippet/constomtextarea.html')
  , constomtimeselecter      = require('text!templates/snippet/constomtimeselecter.html')
  , constomselect            = require('text!templates/snippet/constomselect.html')
  , constomfileupload        = require('text!templates/snippet/constomfileupload.html')
  , constomsubmitbutton      = require('text!templates/snippet/constomsubmitbutton.html')
  , constomagreesubmitbutton = require('text!templates/snippet/constomagreesubmitbutton.html')
  , componenttextarea        = require('text!templates/snippet/componenttextarea.html');
  ...
  return {
    ...
    , textarea                 : textarea
    , textinput                : textinput
    , constomtextinput         : constomtextinput
    , constomtextarea          : constomtextarea
    , constomtimeselecter      : constomtimeselecter
    , constomselect            : constomselect
    , constomfileupload        : constomfileupload
    , constomsubmitbutton      : constomsubmitbutton
    , constomagreesubmitbutton : constomagreesubmitbutton 
