...
<!--内容  -->
	<div class="center_dv">
		...
		<div class="center_dv_dv2">
			...
			<div class="center_span">
				<span>用警时间</span> <span class="center_span_s2"><fmt:formatDate
						value="${yongjing.time}" type="both"
						pattern="yyyy-MM-dd HH:mm:ss" /></span>
			</div>
			<div class="center_span">
				<span>用警事由</span> <span class="center_span_s2">${yongjing.event}</span>
			</div>
			<div class="center_span">
	...
	<!--审批流程-->
	<form:form id="inputForm" modelAttribute="yongjing"
		action="${ctx}/shenpi/yongjing/saveAudit" method="post"
		...
		<div class="liu_dv">
		<act:histoicMobileFlowList_2 procInsId="${yongjing.act.procInsId}" />
		<div class="xian"></div>
		<c:if test="${!empty yongjing.copy }">
			<act:histoicMobileFlowList_3 procInsId="${yongjing.copy}" />
		</c:if  >
		<c:if test="${empty yongjing.copy }">
