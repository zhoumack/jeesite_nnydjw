...
<!--内容  -->
	<%@include file="/WEB-INF/views/include/mmenu.jsp" %>
			<div class="div_body">
				<form:form id="_form" action="${ctx}/shenpi/yongjing/save" modelAttribute="yongjing" method="post" onsubmit="sub_form(this);return false;">
					<form:hidden path="id" />
					...
					<div class="t_row">
						<div class="row_div">
							<a class="t_a" onclick="openPicker(this)" href="#">
								<span class="t_span">用警类型<span class="bt_span">*</span></span>
								<div class="t_div">
					...
					<div class="t_row">
						<div class="row_div">
							<a class="t_a" href="#">
								<span class="t_span">出警地点<span class="bt_span">*</span></span>
								<div class="t_div">
									<input id="place" placeholder="出警地点" class="t_input" type="text" name="place" />
								</div>
							</a>
						</div>
						<div class="row_div">
							<a class="t_a" onclick="openTimePicker(this)" href="#">
								<span class="t_span">用警时间<span class="bt_span">*</span></span>
								<div class="t_div">
									<input id="time" type="text" name="time" placeholder="请选择" class="t_input" readonly="readonly" />
								</div>
							</a>
						</div>
					</div>
