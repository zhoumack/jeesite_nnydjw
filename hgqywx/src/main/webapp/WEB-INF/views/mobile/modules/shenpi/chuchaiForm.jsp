...
<!--内容  -->
	<form:form id="inputForm" modelAttribute="chuchai"
		action="${ctx}/shenpi/chuchai/save" method="post"
		class="form-horizontal">
		<div class="center_dv">
			<div class="center_dv_dv" style="float: left">
				<img src="${ctxStatic}/mui/img/header.jpg" width="30px"
					height="30px" style="border-radius: 5px" /> <span>${chuchai.user.name}的出差申请</span>
			</div>
			<div class="sp_dv" style="float: left">
				<span id="shenpi">${chuchai.status}</span>
			</div>
			...
			<div class="center_dv_dv2">
				...
				<div class="center_span">
					<span>出差时长</span> <span class="center_span_s2">${chuchai.totaldays}天
					</span>
				</div>
				<div class="center_span">
					<span>出差事由</span>
				...
				<div class="center_span">
					...
					<div style="margin-top: 10px">
						<c:forEach items="${chuchai.filepath.split(',') }" var="img"
							varStatus="status">
							<c:if test="${!empty img}">
		...
		<act:histoicMobileFlowList procInsId="${chuchai.procInsId}" />
	</form:form>
