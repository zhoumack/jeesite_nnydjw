...
<!--内容  -->
<form:form id="inputForm" modelAttribute="bangongqu" action="${ctx}/shenpi/bangongqu/save" method="post" class="form-horizontal">
	<div class="center_dv">
		...
		<div class="sp_dv" style="float: left">
			<span id="shenpi">${bangongqu.status }</span>
		</div>
  	...
  	<div id="spyijian" style="display: none;">
	      ...
	      <input class="weui-input" type="hidden" name="act.comment"  value="${bangongqu.remarks }">
		</div>
  	...
  	<act:histoicMobileFlowList procInsId="${bangongqu.procInsId}" />
  	</form:form>
