...
<!--内容  -->
	<%@include file="/WEB-INF/views/include/mmenu.jsp" %>
			<div class="div_body">
			<!-- ${ctx}/shenpi/qingjia/save  modelAttribute="qingjia"-->
				<form:form id="qj_form" action="${ctx}/shenpi/waichu/save" method="post" onsubmit="sub_form(this);return false;">
<%-- 					<form:hidden path="id" /> --%>
...
<%-- 					<form:hidden id="flag" path="act.flag" /> --%>
					...
					<div class="t_row">
						<div class="row_div">
							<a class="t_a" href="#">
								<span class="t_span">外出地点<span class="bt_span">*</span></span>
								<div class="t_div">
									<input placeholder="外出地点" class="t_input" type="text" name="place" id="place" />
								</div>
							</a>
						</div>
					</div>
					...
					<div class="t_row">
						...
						<div class="row_div">
							<a class="t_a" href="#">
								<span class="t_span">外出时长<span class="bt_span">*</span></span>
					...
					<div class="t_row">
						<div class="row_div">
							<div>外出事由</div>
							<div class="t_ta_div">
								<textarea name="event" placeholder="请输入外出事由" class="t_textarea" type="text"></textarea>
							</div>
						</div>
					</div>
