...
<form:form id="inputForm" modelAttribute="bgyplq" action="${ctx}/shenpi/bgyplq/save" method="post" class="form-horizontal">
	<div class="center_dv">
		<div class="center_dv_dv" style="float: left">
			...
			<span>${bgyplq.user.name}的耗材配件申请</span>
		</div>
		<div class="sp_dv" style="float: left">
			<span id="shenpi">${bgyplq.status }</span>
		</div>
		...
		<div class="center_dv_dv2">
			...
			<div class="center_span">
				<span>领用时间</span> <span class="center_span_s2"><fmt:formatDate
						value="${bgyplq.date}" type="both"
  	...
  	<div id="spyijian" style="display: none;">
	      ...
	      <input class="weui-input" type="hidden" name="act.comment"  value="${bgyplq.remarks }">
		</div>
  	...
  	<act:histoicMobileFlowList procInsId="${bgyplq.procInsId}" />
  	</form:form>
  	</div>
</div>
	<script>
