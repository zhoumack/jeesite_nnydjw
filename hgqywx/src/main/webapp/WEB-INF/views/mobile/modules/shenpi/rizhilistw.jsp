	...
	<div id="poper_dv">
		...
		<div id="slider" style="border-bottom: 1px solid #dcdcdc;">
			<div style="background-color: #fff;" id="sliderSegmentedControl" class="mui-slider-indicator mui-segmented-control mui-segmented-control-inverted">
				<a href="${ctx}/grsw/rizhi/list" id="daiban" class="mui-control-item ">
					已读
				</a>
				<a id="yiban" href="${ctx}/grsw/rizhi/list?remarks=0"  style="border-bottom: 1px solid #007aff;" class="mui-control-item mui-active">
					未读
				</a>
			</div>
		</div>
			...
			<div id="scroll1"  class="mui-slider mui-scroll">
						...
						<ul class="mui-table-view">
							<li class="mui-table-view-cell mui-media" style="border-bottom: 1px solid #e5e5e5;">
								<a href="${ctx}/grsw/rizhi/form?id=${rizhi.id}&remarks=1"> 
									<c:choose>
