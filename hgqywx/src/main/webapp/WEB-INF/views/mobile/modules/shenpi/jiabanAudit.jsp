...
<!--内容  -->
	<div class="center_dv">
		<div class="center_dv_dv" style="float: left">
			...
			<span>${jiaban.user.name }的加班申请</span>
		</div>
		...
		<div class="center_dv_dv2">
			...
			<%-- <div class="center_span">
				<span>加班时长</span> <span class="center_span_s2">${jiaban.totaldays}</span>
			</div> --%>
			<div class="center_span">
			...
			<div class="center_span">
				...
				<div style="margin-top: 10px">
					<c:forEach items="${jiaban.filepath.split(',') }" var="img" varStatus="status">
						<c:if test="${!empty img}">
	...
	<!--审批流程-->
	<form:form id="inputForm" modelAttribute="jiaban"
		action="${ctx}/shenpi/jiaban/saveAudit" method="post"
		...
		<div class="liu_dv">
		<act:histoicMobileFlowList_2 procInsId="${jiaban.act.procInsId}" />
		<div class="xian"></div>
		
		<act:histoicMobileFlowList_3 procInsId="${jiaban.copy}" />
