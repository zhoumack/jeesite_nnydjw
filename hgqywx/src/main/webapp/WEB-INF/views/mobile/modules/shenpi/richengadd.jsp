			...
			<form:form id="richeng_form" action="${ctx}/grsw/richeng/save" modelAttribute="richeng" method="post" onsubmit="sub_form(this);return false;">
					<div class="t_row">
	 					<div class="row_div">
 							<a class="t_a" href="#">
	 							...
	 							<div class="t_div">
								<input id="theme" placeholder="主题" class="t_input" type="text" name="theme" /> 
	 							</div> 
	 						</a> 
	 					</div> 
					</div>
					...
					<div class="t_row">
						...
						<div class="row_div">
 							<a class="t_a" href="#">
	 							...
	 							<div class="t_div">
								<input id="addr" placeholder="地点" class="t_input" type="text" name="addr" /> 
	 							</div> 
	 						</a> 
	 					</div> 
					</div>
					...
					<div class="t_row">
						<div class="row_div">
							<div>日程详情</div>
							<div class="t_ta_div">
								<textarea id="content" name="content" placeholder="请填写详情" class="t_textarea" type="text"></textarea>
							</div>
						</div>
					</div>
					<div class="btn_div">
