...
<!--内容  -->
	...
	<!--审批流程-->
	<form:form id="inputForm" modelAttribute="waichu"
		action="${ctx}/shenpi/waichu/saveAudit" method="post"
		...
		<div class="liu_dv">
		<act:histoicMobileFlowList_2 procInsId="${waichu.act.procInsId}" />
		<div class="xian"></div>
		<c:if test="${!empty waichu.copy }">
			<act:histoicMobileFlowList_3 procInsId="${waichu.copy}" />
		</c:if  >
		<c:if test="${empty waichu.copy }">
