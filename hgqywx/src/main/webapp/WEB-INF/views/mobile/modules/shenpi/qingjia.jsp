...
<script type="text/javascript">
			...
			function calc_qjsj() {
				...
				if(starttime_val && endtime_val) {
					...
					var date3 = oDate4.getTime() - oDate3.getTime(); //时间差的毫秒数      
					//计算出相差天数
...
<body>
	...
	<!--内容  -->
	<div class="div_body">
		<form:form id="qj_form" action="${ctx}/shenpi/qingjia/save"
			modelAttribute="qingjia" method="post"
			...
			<div class="t_row">
				<div class="row_div">
					<a class="t_a" onclick="openPicker(this)" href="#"> <span
						class="t_span">请假类别<span class="bt_span">*</span></span>
						<div class="t_div">
							<input id="qjlx_text" placeholder="请选择" class="t_input"
								type="text" readonly="readonly" /> <input id="qjlx_val"
			...
			<div class="t_row">
				...
				<div class="row_div">
					<a class="t_a" href="#"> <span class="t_span">请假时长<span
							class="bt_span">*</span></span>
						<div class="t_div"
							style="padding-right: 20px; position: relative;">
							<input id="qjsc" name="totaldays" class="t_input" type="text"
								value="0" readonly="readonly" style="color: red;" /> <span
								style="position: absolute; top: 0; right: 0; color: gray;">天</span>
						</div>
					</a>
				</div>
			</div>
			...
			<div class="t_row">
				<div class="row_div">
					<div>请假事由</div>
					<div class="t_ta_div">
						<textarea name="reason" placeholder="请输入请假事由" class="t_textarea"
							type="text"></textarea>
					</div>
				</div>
			</div>
					...
					<div class="t_ta_div mui-row mui-col-xs-12 sel_top_div">
						...
						<div class="mui-col-xs-3 sel_a_div">
							<a class="sel_a" href="#menu" sel_type="csr"
								onclick="sel_click(this)"></a> <input id="csr" name="copy"
								type="hidden" value='' />
						</div>
					</div>
				</div>
