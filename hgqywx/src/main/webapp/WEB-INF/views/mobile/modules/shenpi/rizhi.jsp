...
<script type="text/javascript">
			...
			function sub_vail() {
					...
					var work_tomorrow = $("#work_tomorrow").val();
					if(!work_tomorrow){
						mui.toast('请填写明日计划');
						return false;
					}
...
<body>
	...
	<%-- <%@include file="/WEB-INF/views/include/xuanfu.jsp" %> --%>
			<!-- 悬浮区 -->
			<%-- <img id="xuanfu" src="${ctxStatic}/mui/image/fanhui.png"> --%>
			...
			<!--内容  -->
			<div class="div_body">
			<form:form id="rizhi_form" action="${ctx}/grsw/rizhi/save" modelAttribute="rizhi" method="post" onsubmit="sub_form(this);return false;">
				<%--	<form:hidden path="id" />
					...
					<div class="t_row">
						<div class="row_div">
							<div>今日工作 <span class="bt_span">*</span></div>
							<div class="t_ta_div">
								<textarea id="reason" name="workToday" placeholder="请输入今日工作" class="t_textarea" type="text"></textarea>
							</div>
						</div>
					</div>
					<div class="t_row">
						<div class="row_div">
							<div>明日计划<span class="bt_span">*</span></div>
							<div class="t_ta_div">
								<textarea id="work_tomorrow" name="workTomorrow" placeholder="请输入明日计划" class="t_textarea" type="text"></textarea>
							</div>
						</div>
					</div>
					<div class="t_row">
						<div class="row_div">
							<div>备注</div>
							<div class="t_ta_div">
								<textarea id="other" name="other" placeholder="请输入其他事项" class="t_textarea" type="text"></textarea>
							</div>
						</div>
					</div>
						...
						<div class="row_div">
							...
							<div class="t_ta_div mui-row mui-col-xs-12 sel_top_div">
								<div class="mui-col-xs-3 sel_a_div">
									...
									<input id="spr" name="report" type="hidden" value='' /> <!-- id="spr" name="approve" -->
								</div>
							</div>
						</div>
					</div>
