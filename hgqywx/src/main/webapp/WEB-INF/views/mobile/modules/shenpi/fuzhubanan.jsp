		...
		<div class="mui-scroll">
			<a href="#" class="cent_menu">
				<div class="cent_menu_dv">
					<img src="${ctxStatic}/mui/img/anjiantaolun.png"/>
				</div>
				<p>案件讨论</p>
			</a>
			<a href="#" class="cent_menu">
				<div class="cent_menu_dv">
					<img src="${ctxStatic}/mui/img/anjianxinxi.png"/>
				</div>
				<p>案件信息查询</p>
			</a>
			<a href="#" class="cent_menu">
				<div class="cent_menu_dv">
					<img src="${ctxStatic}/mui/img/anjianjiya.png"/>
				</div>
				<p>案件羁押超期提醒</p>
			</a>
			<a href="#" class="cent_menu">
				<div class="cent_menu_dv">
					<img src="${ctxStatic}/mui/img/falvfagui.png"/>
				</div>
				<p>法律法规</p>
			</a>
			<a href="#" class="cent_menu">
				<div class="cent_menu_dv">
					<img src="${ctxStatic}/mui/img/fuzhubanan.png"/>
				</div>
				<p>辅助办案助手</p>
			</a>
			<a href="#" class="cent_menu">
				<div class="cent_menu_dv">
					<img src="${ctxStatic}/mui/img/jiansuo.png"/>
				</div>
				<p>检索</p>
			</a>
			<a href="#" class="cent_menu">
				<div class="cent_menu_dv">
					<img src="${ctxStatic}/mui/img/zhengjushencha.png"/>
				</div>
				<p>证据审查指引助手</p>
			</a>
		</div>
