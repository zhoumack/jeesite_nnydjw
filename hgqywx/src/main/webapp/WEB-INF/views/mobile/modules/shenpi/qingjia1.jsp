...
<body bgcolor="f8f8f8">
	...
	<!--内容区-->
	<form:form id="form" modelAttribute="qingjia" action="${ctx}/shenpi/qingjia/save" method="post">
		<form:hidden path="id"/>
		...
		<div class="weui-cells weui-cells_form">
	  		<div class="weui-cell">
			    <div class="weui-cell__hd">
			    	...
			    	申请人
			    	<img src="${qingjia.user.photo}" width="8" height="8" class="f_padding pr10" />
			    	</label>
			    </div>
			    <div class="weui-cell__bd">
			      <input class="weui-input" type="text"  name="userName"  value="${qingjia.userName}" required placeholder="请输入" emptyTips="请输入姓名" notMatchTips="请输入正确的姓名">
			  	</div>
		    ...
		    <div class="weui-cell">
			    ...
			    <div class="weui-cell__bd">
			      <input class="weui-input"  name="type" type="text"  id='qingjia' value="${qingjia.type}" placeholder="请输入"  emptyTips="请选择" notMatchTips="请选择">
			  	</div>
		    </div>
	    </div>
	    <div class="weui-cells weui-cells_form">
		    <div class="weui-cell">
                ...
                <div class="weui-cell__bd">
                    <input class="weui-input" id="star"  value="<fmt:formatDate value="${qingjia.starttime}" type="both" pattern="yyyy-MM-dd HH:mm"/>"  name="starttime"  placeholder="请选择" required emptyTips="请选择开始时间" notMatchTips="请选择"/>
                </div>
            </div>
            <div class="weui-cell">
                <div class="weui-cell__hd">
                ...
                <div class="weui-cell__bd">
                    <input class="weui-input" id="end" name="endtime" value="<fmt:formatDate value="${qingjia.endtime}" type="both" pattern="yyyy-MM-dd HH:mm"/>" placeholder="请选择"/>
                </div>
            </div>
		    <!-- <div class="weui-cell">
		...
		<div class="weui-cells weui-cells_form">
		  	<div class="weui-cell">
			    <div class="weui-cell__bd">
			      <textarea class="weui-textarea" name="reason" id="weui-textarea" onkeyup="astrict()"  placeholder="请输入200字以内" maxlength="200" rows="3">${qingjia.reason }</textarea>
	    ...
	    <a  class="weui-media-box weui-media-box_appmsg weui-cells">
	      <div class="weui-media-box__bd">
	        ...
	        <p class="weui-media-box__desc">
	        	<span id="tid" style="position: relative;">
	        	</span>
    ...
    <script type="text/javascript">
    	...
    	$(document).on("click", "#rclick", function() {
			...
			var p =$('<span id="'+nid+'" name="username" style="padding: 10px">' + name + '<img id="deimg" src="${ctxStatic}/weui/img/chahao.png"  onclick="del()" width="15px" height="15px" style="position: absolute;"/></span>');
	    ...
	    $(function(){
			...
			function djclick(){
				...
				$('.weui-cells_checkbox').on('touchstart',function(){
					var txiang = $("#txiang").attr("src");
					console.log(txiang);
					var tupian =$('<img src="'+txiang+'" width="50px" height="50px"/>');
					$("#tspan").append(tupian);
