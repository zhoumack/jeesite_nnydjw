...
<!--内容  -->
	<%@include file="/WEB-INF/views/include/mmenu.jsp" %>
			<div class="div_body">
				<form:form id="form" modelAttribute="yongzhang" action="${ctx}/shenpi/yongzhang/save" method="post" onsubmit="sub_form(this);return false;">
				<form:hidden path="id" />
				...
				<form:hidden id="flag" path="act.flag" />
					...
					<div class="t_row">
						<div class="row_div">
							<a class="t_a" onclick="openPicker(this)" href="#">
								<span class="t_span">用章类型<span class="bt_span">*</span></span>
								<div class="t_div">
					...
					<div class="t_row">
						<div class="row_div">
							<a class="t_a" href="#">
								<span class="t_span">文件名称<span class="bt_span">*</span></span>
								<div class="t_div">
									<input id="filename" placeholder="文件名称" class="t_input" type="text" name="filename"/>
								</div>
							</a>
						</div>
						<div class="row_div">
							<a class="t_a" href="#">
								<span class="t_span">文件份数<span class="bt_span">*</span></span>
								<div class="t_div">
									<input id="filenums" placeholder="文件份数" class="t_input" type="number" name="filenums"/>
								</div>
							</a>
						</div>
						<div class="row_div">
							<a class="t_a" href="#">
								<span class="t_span">存档份数</span>
								<div class="t_div">
									<input class="t_input" type="number" name="savenums" value="0"/>
								</div>
							</a>
						</div>
						<div class="row_div">
							<a class="t_a" onclick="openTimePicker(this)" href="#">
								<span class="t_span">用章时间<span class="bt_span">*</span></span>
								<div class="t_div">
					...
					<div class="t_row">
						<div class="row_div">
							<div>用章事由</div>
							<div class="t_ta_div">
								<textarea name="event" placeholder="请输入用印事由" class="t_textarea" type="text"></textarea>
							</div>
						</div>
					</div>
