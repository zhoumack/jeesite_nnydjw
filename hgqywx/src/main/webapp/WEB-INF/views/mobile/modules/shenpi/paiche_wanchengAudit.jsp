		...
		<div class="t_row">
			<div class="row_div">
				<a class="t_a" onclick="openTimePicker(this)" href="#">
					<span class="t_span">回院时间<span class="bt_span">*</span></span>
					<div class="t_div">
						<input id="hysj" type="text" name="hysj" placeholder="请选择" class="t_input" readonly="readonly" />
					</div>
				</a>
			</div>
		</div>
			...
			<div class="mui-row mui-col-xs-12">
				<button class="mui-col-xs-12" type="button" id="tongyi" onclick="sub_form('1')">
					<img src="${ctxStatic}/mui/img/tongyi.png" width="20px"
						height="20px" style="position: relative; top: 5px" />提交
				</button>
			</div>
		</div>
	</form:form>
