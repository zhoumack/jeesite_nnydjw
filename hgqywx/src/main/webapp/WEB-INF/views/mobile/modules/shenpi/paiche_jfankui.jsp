			...
			<div class="div_body">
				<%-- <form:form id="qj_form" action="${ctx}/shenpi/weixiu/save" modelAttribute="weixiu" method="post" onsubmit="sub_form(this);return false;">
					...
					<div class="t_row"> 
						<div class="row_div">
							<a class="t_a" href="#">
								<span class="t_span">驾驶员</span>
								<div class="t_div">
									<input id="gzsb" readonly="readonly" class="t_input fankui_input" type="text" name="item" value="杨国强" /> 
								</div>
							</a>
						</div>
					</div>
					...
					<div class="t_row">
						<div class="row_div">
							<a class="t_a" href="#">
								<span class="t_span">车牌</span>
								<div class="t_div">
									<input id="gzsb" readonly="readonly" class="t_input fankui_input" type="text" name="item" value="123456789" /> 
								</div>
							</a>
						</div>
						<div class="row_div">
							<a class="t_a" href="#">
								<span class="t_span">联系电话</span>
								<div class="t_div">
									<input id="gzsb" readonly="readonly" class="t_input fankui_input" type="text" name="item" value="1234567890" /> 
								</div>
							</a>
						</div>
					</div>
