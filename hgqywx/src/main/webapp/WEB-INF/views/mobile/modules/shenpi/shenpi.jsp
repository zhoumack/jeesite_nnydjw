...
<body>
	<!--头部-->
	<div class="header">
		<a href="index.jsp" class="img_left">
	...
	<!--内容区-->
	 <div class="weui-grids">
        ...
        <a href="caigou.html" class="weui-grid">
            <div class="weui-grid__icon">
    ...
    <div class="footer">
		...
		<div class="footer_dv pr">
			<a href="${ctx}/shenpi/yitijiao/form">
