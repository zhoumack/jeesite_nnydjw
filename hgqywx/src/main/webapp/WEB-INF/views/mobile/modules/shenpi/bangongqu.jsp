...
<!--内容  -->
	<%@include file="/WEB-INF/views/include/mmenu.jsp" %>
			<div class="div_body">
				<form:form id="_form" action="${ctx}/shenpi/bangongqu/save" modelAttribute="bangongqu" method="post" onsubmit="sub_form(this);return false;">
					<form:hidden path="id" />
					...
					<div class="t_row">
						<div class="row_div">
							<a class="t_a" onclick="openPicker(this)" href="#">
								<span class="t_span">办公室类型<span class="bt_span">*</span></span>
								<div class="t_div">
								<input id="qjlx_text" placeholder="请选择" class="t_input" type="text" readonly="readonly" /> 
								<input id="qjlx_val" type="hidden" name="bgsType" />
								</div>
							</a>
						</div>
					</div>
					...
					<div class="t_row">
						<div class="row_div">
							<a class="t_a" href="#">
								...
								<div class="t_div">
									<input id="roomNo" placeholder="房间号" class="t_input" type="text" name="roomNo" />
								</div>
							</a>
						</div>
						<div class="row_div">
					...
					<div class="t_row">
						<div class="row_div">
							<div>申请事由 <span class="bt_span">*</span></div>
							<div class="t_ta_div">
								<textarea id="event" name="event" placeholder="请输入" class="t_textarea" type="text"></textarea>
							</div>
						</div>
					</div>
					<div class="t_row">
