	...
	<div class="timeline" style="background-color: white;">
  	...
  	<div id="spyijian">
		 ...
		 <div class="weui-cell weui_footer2"> 
			<button class="weui_footer_p1" type="submit" id="tongyi"  onclick="$('#status').val('同意');$('#flag').val('1')" href="${ctx }/shenpi/chuchai/saveAudit">同意</a>
			<button class="weui_footer_p2" type="submit" id="jujue"  onclick="$('#status').val('拒绝');$('#flag').val('2')" href="${ctx }/shenpi/chuchai/saveAudit">拒绝</a>
			<c:if test="${not empty isBack}">
				<button class="weui_footer_p3" type="submit" id="bohui"  onclick="$('#status').val('驳回');$('#flag').val('3')" href="${ctx }/shenpi/chuchai/saveAudit">驳回</a>
			</c:if>
			<button class="weui_footer_p4" type="button" id="zhuanshen">转审</a>
		</div>
  	</div>
  	<!--弹出页面-->
