...
<body>
	...
	<div class="weui-cells">
	  	...
	  	<div class="weui-cell">
		    ...
		    <div class="weui-cell__ft">${qingjia.type }</div>
	  	</div>
	...
	<div class="timeline" style="background-color: white;">
  	...
  	<form:form id="inputForm" modelAttribute="qingjia" action="${ctx}/shenpi/qingjia/saveAudit" method="post" class="form-horizontal">
		<form:hidden path="id"/>
    ...
    <div id="half" class="weui-popup__container" >
        ...
        <div class="weui-popup__modal" id="app">
            ...
            <input type="hidden" id="approve" name="approve" value="${qingjia.approve }"/>
        </div>
    </div>
  	</form:form>
