...
<!-- <fieldset>
	<legend>流转信息</legend> -->
	<div id="histoicMobileFlowList_2" class="timeline" style="background-color: white;">
	</div>
<!-- </fieldset> -->
<script type="text/javascript">
	$.get("${ctx}/act/task/histoicFlowData?procInsId=${procInsId}&startAct=${startAct}&endAct=${endAct}&t="+new Date().getTime(), function(data){
		$("#histoicMobileFlowList_2").html(data);
	});
</script>